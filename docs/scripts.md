...
| `fm-dod-lib.sh`          | One owner of the ship definition of done and of the no-mistakes `--intent` contract, rendered by both the brief scaffold and a scout promotion |
